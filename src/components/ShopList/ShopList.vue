                ...
                <a>
                  ...
                  <div class="shop_right">
                    ...
                    <section class="shop_rating_order">
                      <section class="shop_rating_order_left">
                        <div class="star star-24">
                          <span class="star-item on" style="background-image: url(./images/stars/1.png);"></span>
                          <span class="star-item on"></span>
                          <span class="star-item on"></span>
                          <span class="star-item half"></span>
                          <span class="star-item off"></span>
                  ...
                  &.star-48
                    .star-item
                      ...
                      &:last-child
                        margin-right: 0
                      // &.on
                      //   bg-image('images/stars/star48_on@2x.png')
                      // &.half
                      //   bg-image('images/stars/star48_half@2x.png')
                      // &.off
                      //   bg-image('images/stars/star48_off@2x.png')
                  &.star-36
                    .star-item
                      width 15px
                      height 15px
                      ...
                      &:last-child
                        margin-right 0
                      // &.on
                      //   bg-image('images/stars/star36_on@2x.png')
                      // &.half
                      //   bg-image('images/stars/star36_half@2x.png')
                      // &.off
                      //   bg-image('images/stars/star36_off@2x.png')
                  &.star-24
                    .star-item
                      width 10px
                      height 10px
